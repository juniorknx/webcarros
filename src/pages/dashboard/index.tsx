...
export function Dashboard() {
    ...
    async function handleDeleteCars(car: CarProps) {
                ...
                {cars.map(cars => {
                    return (
                        <section key={cars.id} className="w-full bg-white rounded-lg relative">
                            <button className="absolute bg-white w-14 h-14 rounded-full flex items-center justify-center right-2 top-2 drop-shadow" onClick={() => handleDeleteCars(cars)}>
